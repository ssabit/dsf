      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Request Application</a></li>
...
//read table
    ...
    var user_id = <?php echo $sid?>;
		$.post( {
			url: 'general_user_application_ajax.php',
			type: 'post',
			data: {
  ...
  $("#records_content").load('general_user_application_ajax.php',{uid:user_id});
}, 4000)
