...
<head>
  ...
  <title>DSF | Twilio Configure</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Twilio Configure</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Twilio Configure</li>
      </ol>
    </section>
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<button type="button" class="btn btn-primary" data-toggle="modal"  onclick="editRecord();"><i class="fa fa-pencil"></i> Configure</button>
									<!--Update Modal -->
										...
										<div class="modal-dialog">
											...
											<div class="modal-content">
												<div class="modal-header">
													...
													<h3 class="modal-title text-center">Twilio Configure</h3>
												</div>
												<div class="modal-body">
													<form action="" method="post">
													<div class="form-group">
															<label for="sid">Account SID:</label>
															<input type="text" class="form-control" id="u_sid" placeholder="Enter Account SID" name="sid">
														</div>
														<div class="form-group">
															<label for="auth">Authentication Token:</label>
															<input type="text" class="form-control" id="u_auth" placeholder="Enter Authentication Code" name="auth">
														</div>

														<div class="form-group">
															<label for="num">Number:</label>
															<input type="text" class="form-control" id="u_num" placeholder="Enter Twilio Number" name="phone">
														</div>
															<div>

														</div>
														<button onclick="updateRecords();" type="button" name="submit" id="u_submit" class="btn btn-success"><i class="fa fa-check"></i> Update</button>
													</form>
												</div>
...
<script>
	...
	function editRecord() {
		...
		$.post( {
			...
			success: function ( data, status ) {
				var twilio = JSON.parse( data );
				$('#u_sid').val(twilio.sid);
				$('#u_auth').val(twilio.auth);
		    $('#u_num').val(twilio.number);
