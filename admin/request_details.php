      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li ><a href="service_provider.php">Request Controller <span class="sr-only">(current)</span></a></li>
      ...
      <div class="box box-warning">
          ...
          $sql="SELECT * FROM `request_type_date` WHERE type_date_requestid=$requestid";
            ...
            echo ' <tr>';
              ...
              echo '<td style="width: 150px">'.date("Y-M-d", strtotime($row['type_date'])).'</td>';
          ...
          <div class="box-footer">
              ...
              <?php echo '<img class="img-responsive img-circle img-sm" src="../uploads/'.$_SESSION['image'].'" alt="Profile Picture">'; ?>
                ...
                <div class="img-push">
                  <input  id="comment" type="text" class="form-control" placeholder="Write comment..." required >
