...
<head>
  ...
  <title>DSF | Manage Employees</title>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="container">
									...
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-user-plus"></i> Add Employee</button>
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="" method="post">
														...
														<div class="form-group ">
															<label for="service">Dept:</label>
															<div class="">
																<input id="service" name="Service" placeholder="service" class="form-control" type="hidden" style="width:50%;float:left;" value="">

																<SELECT class="form-control" style="width:40%; pading-left:10px; " onChange="this.form.service.value=this.options[this.selectedIndex].value">
									...
									<div class="modal fade" id="myEditModal" role="dialog">
										<div class="modal-dialog">
											...
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="btn btn-warning btn-circle pull-right" data-dismiss="modal">&times;</button>
													<h3 class="modal-title text-center">Edit Employee</h3>
												</div>
												<div class="modal-body">
													<form action="" method="post">
													<div class="form-group">
